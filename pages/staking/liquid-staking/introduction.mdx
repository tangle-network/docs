...
Liquid staking on Tangle lets stakers keep a transferable position while their assets remain delegated to operator-run services. It is implemented as ERC-7540 liquid delegation vaults that wrap the standard staking flow in `MultiAssetDelegation`.
