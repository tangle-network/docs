...
A profile does not pick the coding harness. Blueprint Agent sessions run OpenCode. Choosing between OpenCode, Claude Code, Codex, and the other [supported harnesses](/infrastructure/harnesses) is a Sandbox feature, set per sandbox rather than per profile.
