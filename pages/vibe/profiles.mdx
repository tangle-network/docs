...
- **Harness selection**: OpenCode, Claude Code, Kimi Code, Codex, AMP, Factory Droids, Pi, Hermes, Forge, ACP, Cursor, or CLI base when the product exposes them. The public Sandbox UI picker can expose a smaller product-policy subset and defers Pi, Forge, ACP, and Cursor until product policy lands.
