...
- **Public Sandbox SDK backends**: OpenCode, Claude Code, Kimi Code, Codex, AMP, Factory Droids, Pi, Hermes, Forge, ACP, Cursor, and CLI base.
- **Public Sandbox UI picker**: the product picker exposes a smaller subset and defers Pi, Forge, ACP, and Cursor until copy and compatibility policy land.
