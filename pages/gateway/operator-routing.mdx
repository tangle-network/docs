...
description: Route inference through registered operators on the Tangle network.
---
...
Operators run **Blueprints**: service templates that define what software an operator runs. The inference-related Blueprints the gateway routes through:
