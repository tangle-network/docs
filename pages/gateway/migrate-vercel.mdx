...
description: Switch from Vercel AI Gateway to Tangle Inference.
---

# Migrate from Vercel AI Gateway

Tangle Inference supports the same `providerOptions.gateway` schema as Vercel AI Gateway. Most code works unchanged.
...
| `providerOptions.gateway.zeroDataRetention`      | Same              | 12 verified providers ([live list](/gateway/api-compliance))                                                    |
| `providerOptions.gateway.disallowPromptTraining` | Same              | 17 verified providers ([live list](/gateway/api-compliance))                                                    |
