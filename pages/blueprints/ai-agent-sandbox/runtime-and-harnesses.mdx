...
Do not describe this blueprint as an OpenCode integration, a Codex integration, or a Claude integration. The public Sandbox SDK supports OpenCode plus 11 peer backend types: Claude Code, Kimi Code, Codex, AMP, Factory Droids, Pi, Hermes, Forge, ACP, Cursor, and CLI base. A blueprint service instance asks its operator for the live runtime set through `GET /api/capabilities`.
