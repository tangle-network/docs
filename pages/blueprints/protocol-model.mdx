...
| Query                 | A read through `eth_call`, the indexer, or an operator API.                           |
...
| Heartbeats or status events           | Liveness history and incident timelines.                                  |
