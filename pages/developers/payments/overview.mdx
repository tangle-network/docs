...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/tnt-core/blob/main/src/libraries/Types.sol"
  fromLine={11}
  toLine={45}
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/tnt-core/blob/main/src/core/Jobs.sol"
  fromLine={248}
  toLine={296}
