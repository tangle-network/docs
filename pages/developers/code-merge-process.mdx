...
| [blueprint-agent](https://github.com/tangle-network/blueprint-agent) | Blueprint agent implementation |
| [agent-dev-container](https://github.com/tangle-network/agent-dev-container) | Development container for agents |
...
- **CI checks must pass**: All required status checks must complete successfully before the PR can be merged (see [CI Gates](#ci-gates) below).
