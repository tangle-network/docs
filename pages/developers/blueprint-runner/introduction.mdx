...
<CardGrid
  cards={[
    ...
    {
      title: "Job Triggers",
      description: "A map of cron, on-chain events, webhooks, x402, and custom producers.",
      link: "/developers/blueprint-runner/job-triggers"
    },
    {
      title: "Webhooks",
      description: "Trigger jobs from external HTTP webhooks.",
      link: "/developers/blueprint-runner/webhooks"
    },
    {
      title: "x402 Payments",
      description: "Accept paid HTTP job calls via x402 settlement.",
      link: "/developers/blueprint-runner/x402"
    },
    {
      title: "Consumers",
