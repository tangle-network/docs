...
First, you define the producer you want to use. For example, a `TangleEvmProducer` that listens for `JobSubmitted` events on Tangle EVM. After which, you pass the producer to the Blueprint Runner's builder.
...
<GithubFileReaderDisplay
  ...
  fromLine={24}
  toLine={86}
  title="Tangle EVM Producer Definition"
/>
