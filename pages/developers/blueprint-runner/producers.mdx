...
First, you define the producer you want to use. For example, a `TangleProducer` that listens for `JobSubmitted` events on Tangle. After which, you pass the producer to the Blueprint Runner's builder.
...
<GithubFileReaderDisplay
  ...
  fromLine={1}
  toLine={120}
  title="TangleProducer Definition"
/>
