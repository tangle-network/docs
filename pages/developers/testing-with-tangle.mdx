...
The [Blueprint SDK](https://github.com/tangle-network/blueprint/tree/main) ships a harness that boots Anvil with pre-seeded Tangle Protocol contracts:
...
### Run your blueprint against local Tangle
