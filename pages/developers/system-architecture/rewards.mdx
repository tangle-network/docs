...
When a service pays a fee, `PaymentsDistribution.sol` calculates and routes the split:
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/tnt-core/blob/main/src/core/PaymentsDistribution.sol"
  fromLine={253}
  toLine={324}
  title="PaymentsDistribution: fee distribution + staker routing via ServiceFeeDistributor"
/>
