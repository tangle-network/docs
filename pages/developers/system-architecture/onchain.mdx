...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/tnt-core/blob/main/src/core/Blueprints.sol"
  fromLine={10}
  toLine={74}
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/tnt-core/blob/main/src/core/Quotes.sol"
  fromLine={19}
  toLine={120}
