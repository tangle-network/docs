...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/tnt-core/blob/v2/src/v2/core/Base.sol"
  fromLine={120}
  toLine={169}
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/tnt-core/blob/v2/src/v2/rewards/TangleMetrics.sol"
  fromLine={1}
  toLine={120}
