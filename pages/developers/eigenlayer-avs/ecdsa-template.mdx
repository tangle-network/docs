...
| Stake Registry       | Obtained from Deployment output            |
...
- For an example of a blueprint runner, see [blueprint runner documentation](/developers/tangle-avs#blueprint-runner-architecture).
- For a job implementation example, consult the [job documentation](/developers/tangle-avs#libsrclibrs).
