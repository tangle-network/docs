---
title: Incredible Squaring AVS Example
---
...
[Incredible Squaring blueprint implementation](https://github.com/tangle-network/blueprint/tree/v2/examples/incredible-squaring-eigenlayer).
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/blueprint/blob/v2/examples/incredible-squaring-eigenlayer/src/jobs/initialize_task.rs"
  fromLine={13}
  toLine={46}
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/blueprint/blob/v2/examples/incredible-squaring-eigenlayer/src/jobs/compute_x_square.rs"
  fromLine={21}
  toLine={106}
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/blueprint/blob/v2/examples/incredible-squaring-eigenlayer/src/lib.rs"
  fromLine={9}
  toLine={48}
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/blueprint/blob/v2/examples/incredible-squaring-eigenlayer/src/main.rs"
  fromLine={41}
  toLine={47}
...
```shell
git clone --branch v2 https://github.com/tangle-network/blueprint.git
cd blueprint
```
