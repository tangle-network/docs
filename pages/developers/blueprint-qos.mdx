---
title: Quality of Service (QoS) Integration Guide
---
...
- Familiarity with Tangle architecture
...
To enable the heartbeat service, you must implement the `HeartbeatConsumer` trait, which is responsible for sending heartbeat signals to Tangle:
