...
The QoS system is designed to be added to any Blueprint type (Tangle EVM, P2P, or Cron) as a background service.
...
async fn main() -> Result<(), blueprint_sdk::Error> {
    ...
    BlueprintRunner::builder(TangleEvmConfig::default(), env)
        .router(Router::new()
            .route(JOB_ID, handler.layer(TangleEvmLayer))
