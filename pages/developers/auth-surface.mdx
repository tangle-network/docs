...
| `claimDisputeBond()`                              | Any address credited in `_pendingDisputeBondRefunds` (disputer after a cancel, treasury after a failed push). Refunds are pull-based, never pushed. | [Slashing.sol](https://github.com/tangle-network/tnt-core/blob/main/src/core/Slashing.sol) |
