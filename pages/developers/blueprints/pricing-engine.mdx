...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/blueprint/blob/v2/crates/pricing-engine/README.md"
  fromLine={1}
  toLine={130}
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/blueprint/blob/v2/crates/pricing-engine/operator.toml"
  fromLine={1}
  toLine={140}
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/blueprint/blob/v2/crates/pricing-engine/config/default_pricing.toml"
  fromLine={1}
  toLine={120}
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/blueprint/blob/v2/crates/pricing-engine/config/job_pricing.toml"
  fromLine={1}
  toLine={80}
