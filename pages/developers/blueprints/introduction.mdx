...
security configuration, and payment token while sharing the same underlying blueprint logic.
...
3. Funds the service fee required by the blueprint manager contract.
