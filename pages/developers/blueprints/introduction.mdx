  ...
  cards={[
    {
      ...
      link: "https://github.com/tangle-network/blueprint/tree/v2"
    },
    {
...
Blueprints using the [Blueprint SDK](https://github.com/tangle-network/blueprint/tree/v2) and deploy them to Tangle v2.
