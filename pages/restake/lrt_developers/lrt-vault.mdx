...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/tnt-core/blob/main/src/staking/LiquidDelegationFactory.sol"
  fromLine={70}
  toLine={149}
...
<GithubFileReaderDisplay
  url="https://github.com/tangle-network/tnt-core/blob/main/src/staking/LiquidDelegationVault.sol"
  fromLine={125}
  toLine={206}
