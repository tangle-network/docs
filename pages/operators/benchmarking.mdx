...
As an operator, you should understand how the protocol benchmarks your system to determine pricing for blueprints. This guide explains the automated benchmarking process and how it affects the quotes generated for your node.
...
When you register as an operator, the protocol can run baseline benchmarks on your system:
...
To learn more about operating on Tangle, you may want to review:

- [Pricing Strategies](/operators/pricing)
- [Quality of Service](/operators/quality-of-service)

Understanding the benchmarking process helps you better appreciate how pricing is determined for blueprints running on your node.
