...
- Review [Runtime Requirements](/operators/manager/requirements), [Sizing and Capacity](/operators/manager/sizing), and [Sandboxing and Security](/operators/manager/security).

## Deployment Inputs (Fill These In)

You will need (Tangle EVM v2):
