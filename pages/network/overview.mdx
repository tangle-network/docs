...
Tangle is an **EVM protocol** for building and running decentralized services secured by restaked assets.
...
> Historical note: earlier iterations of the Tangle network included Substrate-native components and UX (e.g., Polkadot.js flows). This documentation is being migrated to focus on Tangle’s EVM protocol; Substrate-specific pages should be treated as legacy unless explicitly labeled otherwise.
