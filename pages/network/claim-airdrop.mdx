...
<Callout emoji="⚠️">
  The on-chain migration contract defines when eligible balances can migrate and how tokens are released. The portal shows the current deadline, immediately available amount, and release schedule.
</Callout>
