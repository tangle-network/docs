...
TNT can be used within the restaking ecosystem as an operator bond / exposure asset (and may also be accepted for service payments depending on the deployed configuration).
...
A considerable portion of TNT will be actively engaged in the protocol (e.g., governance, operator bonding, incentives), and in the execution of Tangle Blueprints. This helps align economic security with real usage of services.
