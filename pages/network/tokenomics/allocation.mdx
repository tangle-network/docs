...
- Foundation carveout: https://github.com/tangle-network/tnt-core/blob/v2/packages/migration-claim/foundation-carveout.json
- Liquidity ops carveout: https://github.com/tangle-network/tnt-core/blob/v2/packages/migration-claim/liquidity-ops-carveout.json
