...
This page summarizes protocol-level defaults for the Tangle Network EVM deployment. Values are configured per environment and may change via governance or admin controls. For live values, read the contracts on the target network.
